    ...
    <div class='col-md-4 col-md-offset-4'>
        <div class='panel panel-default'>
            ...
            <div class='panel-body'>
                <div class='alert alert-danger alert-dismissable'><span
                ...
                <form>
                    <button class='btn btn-primary btn-xs' data-title='New User' data-toggle='modal'
                            data-target='#addUser' data-placement='top' rel='tooltip'>New User
                    </button>
                </form>
            </div>
        </div>
