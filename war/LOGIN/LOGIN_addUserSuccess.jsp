  ...
  <div class='col-md-4 col-md-offset-4'>
    <div class='panel panel-default'>
      ...
      <div class='panel-body'>
        <div class='alert alert-success alert-dismissable'><span class='glyphicon glyphicon-exclamation-sign'></span>
          Account request created!
          <br/>
          Please wait for your administrator to process your request.
        </div>
